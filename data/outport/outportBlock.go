//go:generate protoc -I=. -I=$GOPATH/src/github.com/ThotaGopichandThota/gn-core3/data/block -I=$GOPATH/src -I=$GOPATH/src/github.com/numbatx/protobuf/protobuf --gogoslick_out=$GOPATH/src outportBlock.proto

package outport

import (
	"github.com/ThotaGopichandThota/gn-core3/data"
	"github.com/ThotaGopichandThota/gn-core3/data/block"
)
