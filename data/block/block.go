//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/numbatx/protobuf/protobuf  --gogoslick_out=$GOPATH/src block.proto
package block
...
import (
	...
	"github.com/ThotaGopichandThota/gn-core3/data/headerVersionData"
)
