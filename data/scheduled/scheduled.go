//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/numbatx/protobuf/protobuf  --gogoslick_out=. scheduled.proto
package scheduled

import (
	"github.com/ThotaGopichandThota/gn-core3/data"
	"github.com/ThotaGopichandThota/gn-core3/data/block"
	"github.com/ThotaGopichandThota/gn-core3/data/smartContractResult"
